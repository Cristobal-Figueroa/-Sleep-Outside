import{g as a,s as n,u as d,a as r}from"./utils-BIapS5SB.js";import{P as c}from"./ProductData-x4V9q2sA.js";class i{constructor(e,t){this.productId=e,this.product={},this.dataSource=t}async init(){this.product=await this.dataSource.findProductById(this.productId),this.renderProductDetails(),document.getElementById("addToCart").addEventListener("click",this.addToCart.bind(this))}addToCart(){const e=a("so-cart")||[];e.push(this.product),n("so-cart",e),d(),this.showAddToCartModal()}showAddToCartModal(){const e=`
